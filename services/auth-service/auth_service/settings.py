...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'unsafe-auth-service-key')
DEBUG = os.getenv('DJANGO_DEBUG', 'True').lower() == 'true'
ALLOWED_HOSTS = [host.strip() for host in os.getenv('DJANGO_ALLOWED_HOSTS', '127.0.0.1,localhost,auth-service').split(',') if host.strip()]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('SQLITE_NAME', BASE_DIR / 'auth.sqlite3'),
    }
}
